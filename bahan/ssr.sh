...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/Sangarya/ntb/main/bahan/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/Sangarya/ntb/main/bahan/ssrmu.sh && chmod +x /usr/bin/ssr
