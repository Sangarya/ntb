...
# install v2ray
wget https://raw.githubusercontent.com/Sangarya/ntb/main/bahan/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -0 del-vless "https://github.com/Sangarya/ntb/raw/main/del/del-vless.sh"
...
wget -O certv2ray "https://raw.githubusercontent.com/Sangarya/ntb/main/bahan/cert.sh"
chmod +x add-ws
chmod +x add-vless
chmod +x add-tr
chmod +x del-ws
