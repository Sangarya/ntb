...
Login=Gabut_`</dev/urandom tr -dc X-Z0-9 | head -c2`
hari="1"
...
echo -e "${yellow}==================${off}"
echo -e "${green}Payload WebSocket"
echo -e ""
echo -e "GET / HTTP/1.1[crlf]Host: $domain[crlf]Connection: Keep-Alive[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]"
echo -e ""
echo -e "GET wss://BUG [protocol][crlf]Host: $domain[crlf]Upgrade: websocket[crlf][crlf]${off}"
echo -e ""
echo -e "${yellow}==================${off}"
